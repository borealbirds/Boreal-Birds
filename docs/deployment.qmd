---
title: "Boreal Avian Modelling (BAM) Centre Dashboard"
...
4. Update `PRODUCTION_TILER_BASE` in the Main Dashboard located in `app/utils/titiler.py` to the link of the deployed app obtained from the previous step.
